...
import { extractAltitude, extractBeaconId, extractHeading, extractProcedureId, extractRunwayId, normalizeVoiceCommand } from "../src/utils/voiceCommandParser.js";
...
const cases = [
  ...
  {
    input: "bravo six zero two seven proceed direct nav one",
    normalized: "b6027 proceed direct nav1",
    beacon: "NAV1",
    beacons: ["NAV1", "NAV2", "NAV3"],
  },
  {
