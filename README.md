...
1. 更新雷达画面与界面细节，增强科技感、可读性和民航空管雷达观感。
2. 新增 Metro Crossing Sector 和 Mountain Valley Approach 两张机场地图，包含不同跑道方向、跑道号、导航台与离场程序。
3. 增加限制区难度挑战：三张地图分别设置 0、1、2 个限制区，难度依次提升。
4. 修复部分 BUG，包括跨地图落地计分、飞机移除、碰撞判定、语音指令提交、飞行速度与起降高度逻辑等问题。
...
语音指令：按住左 Shift 说出标准管制指令，松开后自动提交并由飞机执行。
